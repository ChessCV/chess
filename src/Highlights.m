...
EB = double(rgb2gray(imread('CV Chess/3D IRL/M-B.jpg')));

I1 = double(rgb2gray(imread('CV Chess/3D IRL/M-1.jpg')));
I2 = double(rgb2gray(imread('CV Chess/3D IRL/M-2.jpg')));

LL = imread('CV Chess/3D IRL/M-L.bmp'); F = '....';
